...
namespace App\Conference {
     ...
     */        class ConferenceFacade {
                    /**
         * @static
         */        public static function storeData($request, $slug)
        {
                        /** @var \App\Conference\ConferenceService $instance */
                        return $instance->storeData($request, $slug);
        }
                    /**
         * @static
         */        public static function showDetails($roomName = '', $identity = '')
        {
                        /** @var \App\Conference\ConferenceService $instance */
                        return $instance->showDetails($roomName, $identity);
        }
                    /**
         * @static
         */        public static function closeConnection($conference, $id)
        {
                        /** @var \App\Conference\ConferenceService $instance */
                        return $instance->closeConnection($conference, $id);
        }
                    /**
         * @static
         */        public static function saveVideo($school_slug, $cid = '')
        {
                        /** @var \App\Conference\ConferenceService $instance */
                        return $instance->saveVideo($school_slug, $cid);
        }
                    /**
         * @static
         */        public static function showDuration($roomName = '')
        {
                        /** @var \App\Conference\ConferenceService $instance */
                        return $instance->showDuration($roomName);
        }
            }
    }
...
namespace App\Calendar {
     ...
     */        class CalendarFacade {
        ...
        {
                        /** @var \App\Calendar\CalendarService $instance */
                        return $instance->test();
        }
                    /**
         * @static
         */        public static function events($school_id, $academic_year)
        {
                        /** @var \App\Calendar\CalendarService $instance */
                        return $instance->events($school_id, $academic_year);
        }
                    /**
         * @static
         */        public static function eventscount($school_id, $academic_year)
        {
                        /** @var \App\Calendar\CalendarService $instance */
                        return $instance->eventscount($school_id, $academic_year);
        }
                    /**
         * @static
         */        public static function createEvent($school_id, $academic_year, $request)
        {
                        /** @var \App\Calendar\CalendarService $instance */
                        return $instance->createEvent($school_id, $academic_year, $request);
        }
                    /**
         * @static
         */        public static function getEvent($events_id, $school_id)
        {
                        /** @var \App\Calendar\CalendarService $instance */
                        return $instance->getEvent($events_id, $school_id);
        }
                    /**
         * @static
         */        public static function updateEvent($event_id, $school_id, $academic_year, $request)
        {
                        /** @var \App\Calendar\CalendarService $instance */
                        return $instance->updateEvent($event_id, $school_id, $academic_year, $request);
        }
                    /**
         * @static
        ...
        {
                        /** @var \App\Calendar\CalendarService $instance */
                        return $instance->deleteEvent($id);
        }
            }
    }
...
namespace  {
            ...
            class Conference extends \App\Conference\ConferenceFacade {}
            class Calendar extends \App\Calendar\CalendarFacade {}

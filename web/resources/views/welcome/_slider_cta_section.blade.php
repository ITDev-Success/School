{{-- SPDX-License-Identifier: MIT --}}
  <div class="container mx-auto homepage pt-8 pb-16 lg:px-32 flex flex-col items-center">
     <div class="image-wrapper mt-2 mb-8">
        <img src="https://gego-static.s3.ap-south-1.amazonaws.com/school/gego_k12_logo.png" class="logo-image h-32" alt="School - School Management System " />
    </div>
    ...
    <div class="font-exo text-lg lg:text-xl font-medium text-black text-center leading-relaxed mb-6 px-5 lg:px-16">School is a modern best-in-class School Management Software, crafted with Cloud Technology to effectively manage all School Operations and effortlessly communicate with Parents and Students through Mobile App.</div> -->
    ...
    <!-- <div class="image-wrapper lg:mt-24 mt-8">
        <img src="https://gego-static.s3.ap-south-1.amazonaws.com/school/gego_k12_school_management_system.jpg" class="cta-image" alt="School School Management System" />
    </div> -->
</div>

...
<div class="container lg:mx-auto lg:my-32 my-2 p-4">
  ...
  <div class="w-full lg:w-2/3 md:w-2/3 mx-auto text-center font-primary leading-relaxed mb-4">
    A proper channelized communication between Parent & School Administration, Parent & Teacher makes a school life better for a student. With School we focus to bring the right tools to make the communication easy, effective and more responsible. With parent apps and teacher apps in place, the communication is simpler and more authentic.
  </div>
  ...
  <div class="flex flex-col lg:flex-row md:flex-row my-8 lg:my-24">
    ...
    <div id="tab-1" class="course_tab_content tab-content current">
     ...
     <p>Through the daily attendance module, parents will be sent a notification and SMS through the module every time their child is absent from school/class. The teacher requires to take the attendance through the module and the app automatically triggers a message to the parents if the child is marked absent.</p>
      <img src="https://gego-static.s3.ap-south-1.amazonaws.com/school/attendance.jpg" class="my-4 mx-auto">
      </div>
      <!-- end -->
      <!-- start -->
      ...
      <img src="https://gego-static.s3.ap-south-1.amazonaws.com/school/homeworks.jpg" class="my-4 mx-auto">
      </div>
      <!-- end -->
      <!-- start -->
    ...
    <div id="tab-5" class="course_tab_content tab-content">
      ...
      <img src="https://gego-static.s3.ap-south-1.amazonaws.com/school/noticeboard.jpg" class="my-4 mx-auto">
      </div>
      <!-- end -->
          <!-- start -->
    <div id="tab-6" class="course_tab_content tab-content">
      ...
      <img src="https://gego-static.s3.ap-south-1.amazonaws.com/school/schoolevents.jpg" class="my-4 mx-auto">
      </div>
      <!-- end -->
        <!-- start -->
    <div id="tab-7" class="course_tab_content tab-content">
      ...
      <img src="https://gego-static.s3.ap-south-1.amazonaws.com/school/discipline.jpg" class="my-4 mx-auto">
      </div>
      <!-- end -->
        <!-- start -->
    <div id="tab-8" class="course_tab_content tab-content">
      ...
      <!-- <img src="https://gego-static.s3.ap-south-1.amazonaws.com/school/home_1.png" class="my-4 mx-auto"> -->
      </div>
      <!-- end -->
        <!-- start -->
    <div id="tab-9" class="course_tab_content tab-content">
      ...
      <img src="https://gego-static.s3.ap-south-1.amazonaws.com/school/feedback.jpg" class="my-4 mx-auto">
      </div>
      <!-- end -->
    </div>
  </div>
